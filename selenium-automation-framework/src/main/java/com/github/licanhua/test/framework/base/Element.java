...
/**
 * The core of the automation framework.
 * @see ElementContext
 * @see com.github.licanhua.test.framework.Page
 * @see CheckBox
 * @see SelectBox
 * @see Container
 * @author Canhua Li
...
public interface Element {
    ...
    // return the parent of this Element. Except Page object, all other element should has a parent.
