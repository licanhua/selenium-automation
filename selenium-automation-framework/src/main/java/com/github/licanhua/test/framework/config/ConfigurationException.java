...
public abstract class ConfigurationException extends RuntimeException {
    ...
    public static class Missing extends ConfigurationException {
        public Missing(String message) {
            super(message);
        }
    }

    public static class ConvertFail extends ConfigurationException {
        public ConvertFail(String message) {
            super(message);
        }
    }

    public static class NotImplement extends ConfigurationException {
